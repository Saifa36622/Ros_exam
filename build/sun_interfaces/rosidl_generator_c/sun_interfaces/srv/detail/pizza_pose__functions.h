...
#ifndef SUN_INTERFACES__SRV__DETAIL__PIZZA_POSE__FUNCTIONS_H_
#define SUN_INTERFACES__SRV__DETAIL__PIZZA_POSE__FUNCTIONS_H_
...
#include "sun_interfaces/msg/rosidl_generator_c__visibility_control.h"

#include "sun_interfaces/srv/detail/pizza_pose__struct.h"

/// Initialize srv/PizzaPose message.
/**
...
/// Create srv/PizzaPose message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * sun_interfaces__srv__PizzaPose_Request__init().
...
/// Destroy srv/PizzaPose message.
/**
 * It calls
 * sun_interfaces__srv__PizzaPose_Request__fini()
...
/// Check for srv/PizzaPose message equality.
/**
...
/// Initialize array of srv/PizzaPose messages.
/**
...
/// Finalize array of srv/PizzaPose messages.
/**
 * It calls
 * sun_interfaces__srv__PizzaPose_Request__fini()
...
/// Create array of srv/PizzaPose messages.
/**
 * It allocates the memory for the array and calls
 * sun_interfaces__srv__PizzaPose_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/PizzaPose messages.
/**
 * It calls
 * sun_interfaces__srv__PizzaPose_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/PizzaPose message array equality.
/**
...
/// Copy an array of srv/PizzaPose messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * sun_interfaces__srv__PizzaPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_sun_interfaces
...
/**
 * It calls
 * sun_interfaces__srv__PizzaPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_sun_interfaces
...
/**
 * It allocates the memory for the array and calls
 * sun_interfaces__srv__PizzaPose_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_sun_interfaces
...
/**
 * It calls
 * sun_interfaces__srv__PizzaPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SUN_INTERFACES__SRV__DETAIL__PIZZA_POSE__FUNCTIONS_H_
